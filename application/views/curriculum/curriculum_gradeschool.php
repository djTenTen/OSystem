<div class="main">
    ...
    <div class="container" style="margin-top:5%">
        <div class="row">
            <div class="col-lg-6">
                <?= form_open('addCurriculumSubjectsGradeschool');?>
                ...
                <?= form_close();?>
                    <!-- CURRICULUM -->
                <?= form_open('addCurriculumGradeschool');?>
                                    ...
                                    <div class="modal fade" id="myModalDelete<?= $row2['subjectID'];?>">
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    ...
                                                    <?= form_open('removeTempSubjectGradeschoolCurri/'.$row2['subjectID']); ?>
            ...
            <div class="col-lg 12">
                <?= form_open('curriculum_gradeschool');?>
