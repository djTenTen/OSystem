<div class="container-fluid">
    ...
    ?>
    <h1>Curriculum Management - Senior High</h1>

    <div class="container" style="margin-top:5%">
        <div class="row">
            <div class="col-lg-6">
                <?= form_open('addCurriculumSubjectsSeniorhigh');?>
                    <div class="form-group" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; font-size: 12px;">
                        <label for="collegeSubject">Subjects:</label>
                            ...
                            <option value="" selected>Search Subects</option>
                                <?php foreach($subjectseniorhigh as $row){?>
                                <option value="<?= $row['subjectID'];?>"><?= '('.$row['category'].')'.$row['subjectCode'] .' - '. $row['subjectDesc'];?></option>
                                <?php }?>
                            </select>
                    </div>
                ...
                <?= form_close();?>
                    <!-- CURRICULUM -->
                <?= form_open('addCurriculumSeniorhigh');?>
                ...
                <!-- </div>
                    <div class="form-group"> -->
                        ...
                        <div class="col-lg-4" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; font-size: 12px; margin-top: 10px;">
                            <label for="email">Strand:</label>
                            <select name="strand" class="form-control form-control-sm" required>
                                    ...
                                    <div class="modal fade" id="myModalDelete<?= $row2['subjectID'];?>">
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    ...
                                                    <?= form_open('removeTempSubjectSeniorhighCurri/'.$row2['subjectID']); ?>
