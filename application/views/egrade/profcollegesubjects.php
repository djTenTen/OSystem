...
<br>
    ...
    <?= form_open('viewclasssubjects/'.$teacherID);?>
        <div class="container">
        ...
        <?php foreach($collegeProfSubjects as $row){?>
            <div class="media border p-3">
                <div class="media-body">
                    <a href="<?= base_url();?>viewclasssubjectsstudentscol/<?= $row['curriculumID'];?>/<?= $row['subjectID'];?>"><h4><?= $row['subjectDesc'];?><small> <i> <?= $row['Year'];?> / <?= $row['Section'];?> / <?= $row['Sem'];?></i></small></h4></a>
