...
<h1>Junior High Subjects</h1>
<h1><?= $Teacher;?></h1>
<br>
<br>

    <?= form_open('viewclasssubjectsjhs/'.$teacherID);?>
        <div class="container">
        ...
        <?php foreach($seniorhighProfSubjects as $row){?>
            <div class="media border p-3">
                <div class="media-body">
                    <a href="<?= base_url();?>viewclasssubjectsstudentsjhs/<?= $row['curriculumID'];?>/<?= $row['subjectID'];?>"><h4><?= $row['subjectDesc'];?><small> <i> <?= $row['Year'];?> / <?= $row['Section'];?></i></small></h4></a>
