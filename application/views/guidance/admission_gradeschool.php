<div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <?= form_open('admission_gradeschool');?>
                ...
                <div class="btn-group btn-group-lg">
                    ...
                    <table class="table table-bordered table-sm" id="datatable">
                        ...
                        <tbody>
                        <?php foreach($admissionJuniorhigh as $row1){?>
                                    ...
                                    <div class="modal fade" id="myModalDismiss<?= $row1['admissionID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <?= form_open('dismiss_gradeschool/'.$row1['admissionID']);?>
                                    ...
                                    <div class="modal fade" id="myModalView<?= $row1['admissionID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                <?= form_open('validate_gradeschool/'.$row1['admissionID']);?>
                                    ...
                                    <div class="modal fade" id="myModalEdit<?= $row1['admissionID'];?>">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal body -->
                                                <?= form_open('updateGradeschool/'.$row1['admissionID']);?>
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <?= form_close();?>
                                                        <?= form_open('printgradeschoolinfo/'.$row1['admissionID']);?>
