<div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <?= form_open('admission_juniorhigh');?>
                                    ...
                                    <div class="modal fade" id="myModalDismiss<?= $row1['admissionID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <?= form_open('dismiss_juniorhigh/'.$row1['admissionID']);?>
                                    ...
                                    <div class="modal fade" id="myModalView<?= $row1['admissionID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                <?= form_open('validate_juniorhigh/'.$row1['admissionID']);?>
                                    ...
                                    <div class="modal fade" id="myModalEdit<?= $row1['admissionID'];?>">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal body -->
                                                <?= form_open('updateJuniorhigh/'.$row1['admissionID']);?>
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <?= form_open('printjuniorhighinfo/'.$row1['admissionID']);?>
