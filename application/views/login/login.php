	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10 col-lg-12 col-md-9" >
				<div class="card o-hidden border-0 shadow-lg my-5" style="background-image: url(<?= base_url();?>img/hccnewlypainted2.jpg); height: auto;
                width: auto;
					...
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block">
                                <img src="<?= base_url();?>img/logo4.png" alt="Logo" class="" style="height:500px;">
							</div>
							
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h3 class="text-white mb-4">Welcome to School Management System!</h3>
									</div>
