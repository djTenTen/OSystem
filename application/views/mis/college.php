                                                ...
                                                <div class="modal-body">
                                                    <div style="overflow-y:scroll;width:100%;height:450px">   
                                                        <table class="table table-hover table-sm" id="header-fixed">
                                                            ...
                                                            <tbody>
                                                                <?php 
                                                                $aID = $row1['admissionID'];
                                                                $lvl = $row1['Level'];
                                                                $sem = $row1['Semester'];
                                                                $query = $this->db->query("select student_subject_college.subjectID,subjectCode,SubjectDesc,lec,labComputer,labNonComputer,units,computeunits,Day,Time,FullName,Prelim,Midterm,Finals,Grade,Remarks,isReleasing,CourseCode,Section
                                                                ...
                                                                and admissionNO = '$aID'
                                                                and student_subject_college.year = '$lvl'
                                                                and semester = '2ND SEM'");
                                                                
                                                                foreach($query->result_array() as $sub){?>
                                                                <tr>
                                                                    <td><?= $sub['subjectCode'];?></td>
                                                                    <td><?= $sub['SubjectDesc'].' - ( '.$sub['CourseCode'].' '. $sub['Section'].')';?> </td>
                                                                    <td><?= $sub['Day'].'/'.$sub['Time'];?></td>
                                                                    <td><?= $sub['Prelim'];?></td>
                                                                    <td><?= $sub['Midterm'];?></td>
                                                                    <td><?= $sub['Finals'];?></td>
                                                                    <td><?= $sub['Grade'];?></td>
