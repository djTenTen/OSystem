<div class="container-fluid">
    <?php
        if($this->session->flashdata('CollegeMiscellaneous_Added') != null){
    ...
    <div class="container container-fluid" style="margin-top: 1%;">
        <div class="row">
            <div class="col-lg-4">
                <?= form_open('addCollegeMiscellaneous')?>
            ...
            <div class="col-lg-8">
                <div style="overflow-y:scroll;width:100%;height:500px">  
                    <table class="table table-bordered table-hover table-sm" bordered="1">  
                        ...
                        <tbody>
                        <?php foreach($miscellaneousCollege as $row){?>
                            <tr> 
                                <td><?= $row['miscID'];?></td>
                            ...
                            <div class="modal fade" id="myModalEdit<?= $row['miscID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <?= form_open('updateCollegeMiscellaneous/'.$row['miscID']);?>
                                                    <div class="form-group">
                                ...
                                <div class="modal fade" id="myModalDelete<?= $row['miscID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                <?= form_open('deleteCollegeMiscellaneous/'.$row['miscID']); ?>
