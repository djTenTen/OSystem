<div class="container-fluid">
    <?php
        if($this->session->flashdata('GradeschoolMiscellaneous_Added') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Miscellaneous successfully added. 
        </div>';
        }

        if($this->session->flashdata('GradeschoolMiscellaneous_Updated') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Miscellaneous successfully updated. 
        </div>';
        }
        
        if($this->session->flashdata('GradeschoolMiscellaneous_Deleted') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Miscellaneous successfully removed. 
        </div>';
        }
    ?>
    <h1>Miscellaneous Management - Gradeschool</h1>

    <div class="container container-fluid" style="margin-top: 1%;">
        <div class="row">
            <div class="col-lg-4">
                <?= form_open('addGradeschoolMiscellaneous')?>
            ...
            <div class="col-lg-8">
                <div style="overflow-y:scroll;width:100%;height:500px">  
                    <table class="table table-bordered table-hover table-sm" bordered="1">  
                        ...
                        <tbody>
                        <?php foreach($miscellaneousGradeschool as $row){?>
                            <tr> 
                                <td><?= $row['miscID'];?></td>
                            ...
                            <div class="modal fade" id="myModalEdit<?= $row['miscID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <?= form_open('updateGradeschoolMiscellaneous/'.$row['miscID']);?>
                                                <div class="form-group">
                                ...
                                <div class="modal fade" id="myModalDelete<?= $row['miscID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                <?= form_open('deleteGradeschoolMiscellaneous/'.$row['miscID']); ?>
