<div class="main">
    <?php
        if($this->session->flashdata('JuniorhighMiscellaneous_Added') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Miscellaneous successfully added. 
        </div>';
        }

        if($this->session->flashdata('JuniorhighMiscellaneous_Updated') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Miscellaneous successfully updated. 
        </div>';
        }
        if($this->session->flashdata('JuniorhighMiscellaneous_Deleted') != null){
            echo '<div class="alert alert-success">
    ...
    <div class="container container-fluid" style="margin-top: 1%;">
        <div class="row">
            <div class="col-lg-4">
                <?= form_open('addJuniorhighMiscellaneous')?>
            ...
            <div class="col-lg-8">
                <div style="overflow-y:scroll;width:100%;height:500px">  
                    <table class="table table-bordered table-hover table-sm" bordered="1">  
                        ...
                        <tbody>
                        <?php foreach($miscellaneousJuniorhigh as $row){?>
                            <tr> 
                                <td><?= $row['miscID'];?></td>
                            ...
                            <div class="modal fade" id="myModalEdit<?= $row['miscID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <?= form_open('updateJuniorhighMiscellaneous/'.$row['miscID']);?>
                                                    <div class="form-group">
                                ...
                                <div class="modal fade" id="myModalDelete<?= $row['miscID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                <?= form_open('deleteJuniorhighMiscellaneous/'.$row['miscID']); ?>
