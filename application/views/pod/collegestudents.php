        ...
        <div style="overflow-y:scroll;width:100%;height:450px">        
            ...
            <?php foreach($students as $row){?>
                <tr>
                    ...
                    <td><?= $row['FullName'];?></td>
                    <td><?= $row['Level'].' - '.$row['CourseCode'];?></td>
                    <td><?= $row['Section'];?></td>
                    <td><?= $row['Contact'];?></td>
                    <td>
                        <div class="btn-group btn-group-sm">
                            <a class="btn btn-outline-success" data-toggle="tooltip" title="View" href="infostudentcollege/<?= $row['admissionID'];?>"><span class="far fa-eye"></span></a>
                        </div>
                    </td>
                </tr>
            <?php }?>
