<div class="main">
    ...
    <div class="container">
        ...
        <table class="table table-borderless table-sm">
            ...
            <tr>
                <td>
                    <h6>Course: <strong><?= $info['CourseCode'];?></strong></h6>
                </td>
                <td>
        ...
        <h4>Log Offenses</h4>
        <?= form_open_multipart("addoffense/".$info['admissionID']);?>
           ...
           <thead>
            ...
            <tbody id="myTable">
                <?php
                    ...
                    $query = $this->db->query("select * from offenses where Student = '$Aid' and dpt = 'College'");
                        ...
                        <div class="modal fade" id="myModalupload<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <?= form_open_multipart('uploadpdf/'.$row['offenseID'].'/'.$info['admissionID']); ?>
                        ...
                        <div class="modal fade" id="myModalClose<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <?= form_open('caseclosed/'.$row['offenseID'].'/'.$info['admissionID']); ?>
                        ...
                        <div class="modal fade" id="myModalDelete<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <?= form_open('deleteoffense/'.$row['offenseID'].'/'.$info['admissionID']); ?>
