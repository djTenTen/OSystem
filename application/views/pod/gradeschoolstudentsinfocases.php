<div class="main">
    ...
    <div class="container">
        ...
        <h1>Grade School - <?= $info['FullName'];?></h1>
        ...
        <h4>Log Offenses</h4>
        <?= form_open_multipart("addoffensegs/".$info['admissionID']);?>
           ...
           <thead>
            ...
            <tbody id="myTable">
                <?php
                    ...
                    $query = $this->db->query("select * from offenses where Student = '$Aid' and dpt = 'Gradeschool'");
                        ...
                        <div class="modal fade" id="myModalupload<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <?= form_open_multipart('uploadpdfgs/'.$row['offenseID'].'/'.$info['admissionID']); ?>
                        ...
                        <div class="modal fade" id="myModalClose<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <?= form_open('caseclosedgs/'.$row['offenseID'].'/'.$info['admissionID']); ?>
                        ...
                        <div class="modal fade" id="myModalDelete<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <?= form_open('deleteoffensegs/'.$row['offenseID'].'/'.$info['admissionID']); ?>
