<div class="container-fluid">
    ...
    <div class="container">
        ...
        <h1>Junior High - <?= $info['FullName'];?></h1>
        <table class="table table-borderless table-sm">
            ...
            <tr>
                ...
                <td>
                    <h6>Level: <strong><?= $info['Level'];?></strong></h6>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <h4>Log Offenses</h4>
        <?= form_open_multipart("addoffensejhs/".$info['admissionID']);?>
           ...
           <thead>
            ...
            <tbody id="myTable">
                <?php
                    ...
                    $query = $this->db->query("select * from offenses where Student = '$Aid' and dpt = 'Juniorhigh'");
                        ...
                        <div class="modal fade" id="myModalupload<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <?= form_open_multipart('uploadpdfjhs/'.$row['offenseID'].'/'.$info['admissionID']); ?>
                        ...
                        <div class="modal fade" id="myModalClose<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <?= form_open('caseclosedjhs/'.$row['offenseID'].'/'.$info['admissionID']); ?>
                        ...
                        <div class="modal fade" id="myModalDelete<?= $row['offenseID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                        <?= form_open('deleteoffensejhs/'.$row['offenseID'].'/'.$info['admissionID']); ?>
