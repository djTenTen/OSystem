<div class="main">
    ...
    <h1>Edit - Senior High Schedule</h1>
    <a href="<?= base_url();?>schedule_seniorhigh" class="btn btn-primary btn-sm">Back</a>
        ...
        <table class="table table-bordered table-hover table-sm" style="margin-top: 1%;">
            ...
            <tbody>
                <?php foreach($curriculumsubjects as $row){?>
                        <?= form_open("updateScheduleSeniorhigh/".$row['csubjectID']);?>
                        <tr>
                            <td><?= $row['subjectID'];?></td>
