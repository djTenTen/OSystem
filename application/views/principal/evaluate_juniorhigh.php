<div class="main">
    ...
    ?>
    <h1>Evaluation / Advising - Juniorhigh</h1>
            ...
            <table class="table table-bordered table-hover table-sm">
                ...
                <?php foreach($validatedStudents as $row){?>
                    <tr>
                        ...
                        <td><?= $row['Level'];?></td>
                        <td>
                            <a class="btn btn-outline-primary btn-sm" href="advice_juniorhigh/<?= $row['admissionID'];?>" data-toggle="tooltip" title="Evaluate"><span class="fas fa-tasks"></span></a>
                        </td>
                    </tr>
                <?php }?>
                </tbody>
