<div class="container-fluid">
    ...
    <h1>List of Grade School Students</h1>
    ...
    <br><br>
        ...
        <div style="overflow-y:scroll;width:100%;height:550px">        
            ...
            <tbody id="myTable">
                <?php foreach($EvaluatedStudents as $row){?>   
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a type="button" href="studentSubjectGradeschool/<?= $row['admissionID'];?>"  class="btn btn-outline-success" data-toggle="tooltip" title="Print"><span class="fas fa-print"></span></a>
                            ...
                            <div class="modal fade" id="myModalReevaluate<?= $row['admissionID'];?>">
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    ...
                                                    <?= form_open('reevaluatestudentGradeschool/'.$row['admissionID']); ?>
