            ...
            <table class="table table-bordered table-hover table-sm" style="margin-top: 1%;">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td><?= $row['Section'];?></td>
                        <td>
                            <a type="button" href="editScheduleGradeschool/<?= $row['curriculumID'];?>"  class="btn btn-outline-primary btn-sm" data-toggle="tooltip" title="Edit Schedule"><span class="far fa-edit"></span></a>
                        </td>
                    </tr>
                    <?php }?>
                </tbody>
