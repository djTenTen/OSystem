    ...
    <div class="container container-fluid">
        ...
        <div style="overflow-y:scroll;width:100%;height:550px">
            <table class="table table-bordered table-hover table-sm" style="margin-top: 1%;">
                ...
                <tbody id="myTable">
                    <?php foreach($curriculumSeniorhigh as $row){?>
                    <tr>
                        ...
                        <td><?= $row['Section'];?></td>
                        <td>
                            <a type="button" href="editScheduleSeniorhigh/<?= $row['curriculumID'];?>"  class="btn btn-outline-primary btn-sm" data-toggle="tooltip" title="Edit Schedule"><span class="far fa-edit"></span></a>
                        </td>
                    </tr>
                    <?php }?>
                </tbody>
