                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a type="button" href="studentSubjectSeniorhigh/<?= $row['admissionID'];?>"  class="btn btn-outline-success" data-toggle="tooltip" title="Print"><span class="fas fa-print"></span></a>
                            ...
                            <div class="modal fade" id="myModalReevaluate<?= $row['admissionID'];?>">
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    ...
                                                    <?= form_open('reevaluatestudentSeniorhigh/'.$row['admissionID']); ?>
