                    ...
                    <?php foreach($curriculumCollege as $row){?>  
                        <tr>
                            ...
                            <td>
                                ...
                                <a type="button" href="editSchedule/<?= $row['curriculumID'];?>"  class="btn btn-outline-primary btn-sm" data-toggle="tooltip" title="Edit Schedule"><span class="far fa-edit"></span></a>
