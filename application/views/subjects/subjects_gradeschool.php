<div class="container-fluid">
    <?php
        if($this->session->flashdata('Gradeschool_Added') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Subject successfully added. 
        </div>';
        }

        if($this->session->flashdata('Gradeschool_Updated') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Subject successfully updated. 
        </div>';
        }
        
        if($this->session->flashdata('Gradeschool_Deleted') != null){
            echo '<div class="alert alert-success">
    ...
    ?>
    <h1>Grade School Subject Management</h1>
    <div class="container" style="margin-top: 1%">
        <div class="row">
            <div class="col-lg-3">
                <?= form_open('addGradeschoolSubjects');?>
            ...
            <div class="col-lg-9">
                ...
                <div style="overflow-y:scroll;width:100%;height:500px">
                    <table class="table table-bordered table-hover table-sm" bordered="1">  
                        ...
                        <tbody>
                        <?php foreach($subject_gradeschool as $row){?>
                            <tr>
                            <td><?= $row['subjectID'];?></td>
                            ...
                            <div class="modal fade" id="myModalEdit<?= $row['subjectID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <?= form_open('updateGradeschoolSubjects/'.$row['subjectID']);?>
                                ...
                                <div class="modal fade" id="myModalDelete<?= $row['subjectID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                <?= form_open('deleteGradeschoolSubjects/'.$row['subjectID']); ?>
