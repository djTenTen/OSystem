<div class="container-fluid">
    <?php
        if($this->session->flashdata('SeniorhighSubject_Added') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Subject successfully added. 
        </div>';
        }

        if($this->session->flashdata('SeniorhighSubject_Updated') != null){
            echo '<div class="alert alert-success">
            <strong>Success! </strong> Subject successfully updated. 
        </div>';
        }
        
        if($this->session->flashdata('SeniorhighSubject_Deleted') != null){
            echo '<div class="alert alert-success">
    ...
    ?>
    <h1>Senior High Subject Management</h1>
    <div class="container" style="margin-top: 1%">
        <div class="row">
            <div class="col-lg-3">
                <?= form_open('addSeniorhighSubjects');?>
                    <div class="form-group">
                        <label class="labelstyle" for="subjectCode">Category</label>
                        <select id="select-state" name="category" class="form-control form-control-sm" required>
                    ...
                    <div class="form-group">
                        <label class="labelstyle" for="lec">Hours / Semester: </label>
                        <input name="hrs" type="number" class="form-control form-control-sm" style="text-transform:uppercase" placeholder="Lecture" id="lec" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-9">
                <?= form_open('subject_seniorhigh');?>
                    <div class="input-group mb-3">
                        <input name="searchSubjects" type="text" class="form-control" placeholder="Search Category / Subject Code/Subject Description">
                ...
                <div style="overflow-y:scroll;width:100%;height:450px">
                    <table class="table table-bordered table-hover table-sm" bordered="1">  
                        ...
                        <tbody>
                        <?php foreach($subject_seniorhigh as $row){?>
                        <tr>
                            <td><?= $row['subjectID'];?></td>
                            <td><?= $row['category'];?></td>
                            ...
                            <div class="modal fade" id="myModalEdit<?= $row['subjectID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <?= form_open('updateSeniorhighSubjects/'.$row['subjectID']);?>
                                ...
                                <div class="modal fade" id="myModalDelete<?= $row['subjectID'];?>">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                <?= form_open('deleteSeniorhighSubjects/'.$row['subjectID']); ?>
